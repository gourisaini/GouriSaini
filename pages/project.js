    ...
    <>
        ...
        <div className={styles.desktop}>
          <div className={styles.box}>
            ...
            <div className={styles.content}>
              <p><b><i><u>Art (Online Art gallery)</u> - JavaScript, HTML, CSS <br /> <br /> Art is a front-end website that allows artists and art enthusiasts to showcase, view, or purchase art pieces.</i></b></p>
          ...
          <div className={styles.box}>
            <div className={styles.content}>
              <p><b><i><u>Loyal Friend(Animal Welfare site)</u> - JavaScript, HTML, CSS <br /> <br /> The website front-end allows the user to adopt a pet, volunteer towards the pet, purchase products that are related to pets, and donate the desired amount to the organization</i></b></p>
              <div style={{ display: 'flex', justifyContent: "space-evenly" }}>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.content}>
              <p><b><i><u>Career Crafts </u>- Node.js, MongoDB, HTML, CSS, Bootstrap, JavaScript <br /> <br />Developed a web application that will auto-generate a nice and properly formatted Resume from the information filled up in a form.The resume is downloadable on PDF format. Also, the user can log in again to access the previous resume that he had made.</i></b></p>
              <div style={{ display: 'flex', justifyContent: "space-evenly" }}>
          ...
          <div className={styles.box}>
            <div className={styles.content}>
              <p><b><i><u>Nmovies</u> - React.js <br /> <br /> Nmovies is a site that provides information related to films and television series you can find ratings and reviews of the newest movies and TV shows including cast, summaries, etc</i></b></p>
              <div style={{ display: 'flex', justifyContent: "space-evenly" }}>
      ...
      <div className={styles.mobile}>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.content}>
            <p><b><i><u>Skin Studio(Cosmetic site)</u> - JavaScript, HTML, CSS <br /> <br />
